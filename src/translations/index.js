  ...
  kz: {
    ...
    topServices: {
      ...
      services: {
        ...
        pensionCertificates:
          "Аударыммен зейнетақы аударымдары туралы анықтама алу",
        f6Certificate: "Ф-6 анықтама (жылжымайтын мүліктің болуы туралы)",
        legalEntityCertificate:
          "Заңды тұлғаны тіркеу туралы анықтама беру",
      },
    },
